...
export interface ApiWebpageRowsWebpageRow extends Schema.CollectionType {
  ...
  attributes: {
    ...
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::webpage-rows.webpage-row',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
    publishedAt: Attribute.DateTime;
    rowName: Attribute.String & Attribute.Required;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::webpage-rows.webpage-row',
      'oneToOne',
...
export interface ApiWebpagesWebpage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    pageUrl: Attribute.String & Attribute.Required & Attribute.Unique;
    publishedAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::settings.setting': ApiSettingsSetting;
      'api::webpage-rows.webpage-row': ApiWebpageRowsWebpageRow;
      'api::webpages.webpage': ApiWebpagesWebpage;
